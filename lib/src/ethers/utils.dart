...
class ContractERC20 {
  ...
  ///
  Future<TransactionResponse> mint(String address, BigInt amount) =>
      contract.send('mint', [address, amount.toString()]);

  ///
  Future<TransactionResponse> burn(BigInt amount) =>
      contract.send('burn', [amount.toString()]);
